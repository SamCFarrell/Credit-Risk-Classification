...
* [`report-template` Markdown File](Resources/report-template.md)
...
Structure your report by using the included `report_template` file, and make sure that it contains the following:
